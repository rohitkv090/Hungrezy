...
function LoginCheckout() {
  ...
  const saveUserAddress = () => {
    ...
    setAddUserAddressDetails(false);
    setUserBackendDetails({...userBackendDetails, address: [...userBackendDetails.address, {'address' : locationSearchResults[0].place_name}]});
  };
            ...
            <div className="d-flex">
              <div className="col-8">
                    ...
                    <div className="card-body">
                      ...
                      >
                        ...
                        <p className="card-text">
                          It's easy to login or create an account with Hungrezy
                        </p>
                ...
                {activeUserDetails && activeUserDetails.email ? (
                  ...
                  //           onClick={() => setAddUserAddressDetails(true)}
                  //         >
                  //           <AddIcon />
                  //           Add New address
                  //         </div>
                  //         {addUserAddressDetails && addUserAddressDetailsDiv}
                  //       </div>
                  //     </div>
                  //   </div>
                  // ) : (
                    <div className=" m-3 mb-5 bg-white rounded">
                      <div className="card p-3">
                        <h4>Delivery Address</h4>
                        <div>
                      {userBackendDetails && userBackendDetails.address?.map((data, i) => {

                        return <div key={i} style={{ display: "flex", margin: "10px 0px", alignItems: 'center' }}>
                            <label htmlFor={'order'+i} style={{ width: "fit-content" }}>
                                <input style={{marginRight: '.5rem'}} type="radio" name={'as'} id={'order'+i}/>
                              {data.address}
                            </label>
                          </div>
                            })}
