    ...
    <>
      <Wrapper>
        <footer className="main-footer">
          <section style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingInline: '3rem', marginTop: '3rem'}} >
            <span style={{color: 'white', fontSize: '2rem', fontWeight: 800}}>Hungrezy</span>
          ...
          <p className="policy container">
            ...
            are properties of their respective owners. 2021-2022 © Hungrezy™ Pvt
